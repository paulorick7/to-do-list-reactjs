    ...
    return (
        <div>
            ...
            <div className="input-group mb-3 task-div" >
                <input type="text" className="form-control" value={valueTask} placeholder="Add a task" onChange={handleValueTaskChange} aria-label="Recipient's username" ></input>
